...
public class APIController {
    ...
    @ResponseBody List<Beer> addBeer(@RequestBody Beer beer,Principal principal) {
    ...
    @GetMapping("/me-beers")
    @ResponseBody List<Beer> listBeers( Principal principal) {
    ...
    private Person findOrCreatePerson(Principal principal) {
    	...
    	System.out.println("my test "+principal);
    	System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@222");
    	
        Person p = personRepository.findByEmail(principal.getName()!=null?principal.getName():"biju");
        if (p == null) {
            p = new Person();
            p.setEmail(principal.getName()!=null?principal.getName():"biju");
            personRepository.save(p);
        }
        return p;
    }
